  ...
  return (
    <DropdownMenu open={open} onOpenChange={setOpen}>
      ...
      <DropdownMenuContent
        ...
        className="border-t-primary-orange mt-[0.25%] w-screen rounded-none border-0 border-t-6 outline-none data-[state=closed]:animate-none data-[state=open]:animate-none"
        onMouseEnter={handleMouseEnter}
        onMouseLeave={handleMouseLeave}
        forceMount
      >
