      ...
      <section className="fade-in">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          <div className="service-card bg-gray-50 rounded-lg shadow-lg p-6">
            <div class=" aspect-square rounded-full bg-primary-orange/25 grid place-items-center w-[70px] h-[70px] mb-5">
              <i class="fi fi-rr-light-emergency-on w-[50px] h-[50px] grid place-items-center m-0 text-3xl"></i>
            </div>
          ...
          <div className="service-card bg-gray-50 rounded-lg shadow-lg p-6">
            <div class=" aspect-square rounded-full bg-primary-orange/25 grid place-items-center w-[70px] h-[70px] mb-5">
              <i class="fi fi-rr-brain w-[50px] h-[50px] grid place-items-center m-0 text-3xl"></i>
            </div>
          ...
          <div className="service-card bg-gray-50 rounded-lg shadow-lg p-6">
            <div class=" aspect-square rounded-full bg-primary-orange/25 grid place-items-center w-[70px] h-[70px] mb-5">
              <i class="fi fi-rr-syringe w-[50px] h-[50px] grid place-items-center m-0 text-3xl"></i>
            </div>
          ...
          <div className="service-card bg-gray-50 rounded-lg shadow-lg p-6">
            <div class=" aspect-square rounded-full bg-primary-orange/25 grid place-items-center w-[70px] h-[70px] mb-5">
              <i class="fi fi-rr-street-view w-[50px] h-[50px] grid place-items-center m-0 text-3xl"></i>
            </div>
          ...
          <div className="service-card bg-gray-50 rounded-lg shadow-lg p-6">
            <div class=" aspect-square rounded-full bg-primary-orange/25 grid place-items-center w-[70px] h-[70px] mb-5">
              <i class="fi fi-rr-sad-tear w-[50px] h-[50px] grid place-items-center m-0 text-3xl"></i>
            </div>
          ...
          <div className="service-card bg-gray-50 rounded-lg shadow-lg p-6">
            <div class=" aspect-square rounded-full bg-primary-orange/25 grid place-items-center w-[70px] h-[70px] mb-5">
              <i class="fi fi-rr-student w-[50px] h-[50px] grid place-items-center m-0 text-3xl"></i>
            </div>
          ...
          <div className="service-card bg-gray-50 rounded-lg shadow-lg p-6">
            <div class=" aspect-square rounded-full bg-primary-orange/25 grid place-items-center w-[70px] h-[70px] mb-5">
              <i class="fi fi-rr-legal w-[50px] h-[50px] grid place-items-center m-0 text-3xl"></i>
            </div>
          ...
          <div className="service-card bg-gray-50 rounded-lg shadow-lg p-6">
            <div class=" aspect-square rounded-full bg-primary-orange/25 grid place-items-center w-[70px] h-[70px] mb-5">
              <i class="fi fi-rr-praying-hands w-[50px] h-[50px] grid place-items-center m-0 text-3xl"></i>
            </div>
          ...
          <div className="service-card bg-gray-50 rounded-lg shadow-lg p-6">
            <div class=" aspect-square rounded-full bg-primary-orange/25 grid place-items-center w-[70px] h-[70px] mb-5">
              <i class="fi fi-rr-house-user w-[50px] h-[50px] grid place-items-center m-0 text-3xl"></i>
            </div>
