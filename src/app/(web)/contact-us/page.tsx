    ...
    rows: [
      {
        ...
        campus: "Parramatta, NSW",
      },
      {
        label: "Deputy Dean & Course Coordinator - Management (Dr. Ali Abusalem)",
        value: "ali.abusalem@churchill.edu.au",
        href: "mailto:ali.abusalem@churchill.edu.au",
        campus: "Melbourne, VIC",
      },
      {
        ...
        <ContainerLayout>
          <div className="mt-10 rounded-md bg-[#E9E9E9] p-4 md:p-6">
            ...
            <div className="mt-6 space-y-8">
              {contactTableSections.map((section) => {
                const hasCampus = section.title === "Key Churchill Staff";

                return (
                  <div key={section.title}>
                    <h4 className="mb-3 text-lg font-bold md:text-xl">{section.title}</h4>
                          ...
                          {section.rows.map((row) => {
                            ...
                            return (
                              <tr key={`${section.title}-${row.label}`} className="align-top">
                                ...
                                {hasCampus && (
                                  <td className="border-b border-neutral-200 px-4 py-3 text-neutral-500">
                                    {row.campus ?? "—"}
                                  </td>
                                )}
                              </tr>
