  ...
  return (
    <SpacingLayout>
      ...
      <ContainerLayout>
        ...
        <div className="mx-auto text-gray-700 text-base leading-relaxed space-y-6">
          <p>
          ...
          <ul className="list-disc list-inside space-y-4">
            <li>
              ...
              <ul className="list-disc ml-6 mt-3 space-y-2">
                ...
                <li>
                  Is delivered over 3 years full-time, face to face on campus
                  over 6 semesters.
                </li>
                <li>
            ...
            <li>
              ...
              attendance), a mid-semester break, a one (1) week study break and
              a two (2) week exam period. Refer to the&nbsp;
              <Link
            ...
            <li>
              Attendance for each unit includes 4 face-to-face contact hours per
              week that are divided into lecture and tutorial components (2-hour
              lecture + 2-hour tutorial).
            </li>
            <li>
              For each contact hour, 1.5 hours of independent study is expected
              from students for every face-to-face hour (4 + 6 = 10 hours’
              workload per unit per week).
            </li>
            <li>
              Full time workload: 4 Units x 10 hours per Unit = 40 hours per
              week.
            </li>
            <li>
              There are usually three (3) to five (5) assessments in all units
              (subjects) that includes a final examination weighted at 40% of
              the unit total. Other assessments in most units include written
              assignments, reports, group or individual presentations and /or in
              class tests of various weightings.
            </li>
            <li>
              All students must additionally complete a module and quiz on
              Academic Integrity and ethical use of Generative Artificial
              Intelligence (GenAI) in their first semester of study at Churchill
              Institute in addition to a standard full-time study load.
            </li>
          </ul>
          ...
          <div className="mt-10">
            ...
            <p className="mb-6">
              The BBus has the following learning outcomes that are consistent
              with AQF Level 7 qualification requirements:
            </p>
