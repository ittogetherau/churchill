          ...
          <div className="max-w-4xl mx-auto text-gray-700 text-base leading-relaxed space-y-6">
            ...
            <ul className="list-disc list-inside space-y-4">
              ...
              <li>
                ...
                attendance), a mid-semester break, a one (1) week study break
                and a two (2) week exam period. Refer to the&nbsp;
                <Link
              ...
              <li>
                Attendance for each unit includes 4 face-to-face contact hours
                per week that are divided into lecture and tutorial components
                (2-hour lecture + 2-hour tutorial).
              </li>
              <li>
                For each contact hour, 1.5 hours of independent study is
                expected from students for every face-to-face hour (4 + 6 = 10
                hours’ workload per unit per week).
              </li>
              <li>
              ...
              <li>
                ...
                assignments, reports, group or individual presentations and /or
                in class tests of various weightings.
              </li>
              <li>
