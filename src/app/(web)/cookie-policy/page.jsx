  ...
  return (
    <>
      <div className="font-sans leading-relaxed max-w-3xl mx-auto p-5">
        ...
        <p className="mb-4">
          This Cookie Policy explains how Churchill Institute of Higher
          Education ("we," "us," or "our") uses cookies and similar technologies
          on our website{" "}
          <a
            href="https://churchill.nsw.edu.au"
            className="text-blue-600 hover:underline"
          >
            https://churchill.nsw.edu.au
          </a>{" "}
        ...
        <p className="mb-4">
          Cookies are small data files stored on your device (computer, tablet,
          or mobile) when you visit a website. They help websites remember your
          preferences, login details, and enhance overall user experience.
        </p>
        ...
        <ul className="list-disc pl-5 mb-4">
          ...
          <li>
            Enable certain third-party features such as videos, maps, and social
            media sharing
          </li>
        </ul>
          ...
          <tbody>
            ...
            <tr>
              ...
              <td className="border border-gray-300 p-2">
                ...
                management, login authentication).
              </td>
            </tr>
            <tr>
              <td className="border border-gray-300 p-2">
              ...
              <td className="border border-gray-300 p-2">
                Help us understand how users interact with our Website (e.g.,
                Google Analytics).
              </td>
            </tr>
            <tr>
              ...
              <td className="border border-gray-300 p-2">
                Enable the Website to remember user choices such as language or
                region.
              </td>
            </tr>
            <tr>
              ...
              <td className="border border-gray-300 p-2">
                Set by services such as embedded videos, social media platforms,
                and external tools.
              </td>
            </tr>
          </tbody>
        ...
        <p className="mb-4">
          We may use third-party services (e.g., Google, Facebook, YouTube) that
          place cookies on your device when you access our content through their
          platforms. We encourage you to review their respective privacy and
          cookie policies.
        </p>
        ...
        <p className="mb-4">
          ...
          in technology, legal requirements, or our operations. Any updates will
