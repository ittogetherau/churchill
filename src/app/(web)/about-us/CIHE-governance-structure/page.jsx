  ...
  return (
    <div>
      ...
      <div className="container mx-auto px-5 mb-20">
        <h3 className="text-[24px] font-bold text-[#2C2B4B] text-center mb-5">
          Registered Company: Mpika Holdings Pty Ltd (ACN: 612 507 141 | ABN: 91
          612 507 141){" "}
        </h3>
        <h4 className="text-[20px] font-semibold text-[#2C2B4B] text-center mb-5">
          Trading Name: Churchill Institute of Higher Education
        </h4>
        <p className="text-[18px] text-[#2C2B4B] text-center mb-5">
